...
const UIEdgeInsets textInsetsMine = {8, 14, 8, 14};
const UIEdgeInsets textInsetsSomeone = {8, 14, 8, 14};
...
{
    UIFont *font = [UIFont fontWithName:@"Helvetica Light" size:15.0f];
    
    CGSize size = [(text ? text : @"") sizeWithFont:font constrainedToSize:CGSizeMake(200, 9999) lineBreakMode:NSLineBreakByTruncatingTail];
    ...
    UIEdgeInsets insets = (type == BubbleTypeSomeoneElse ? textInsetsMine : textInsetsSomeone);
...
- (id)initWithImage:(UIImage *)image date:(NSDate *)date type:(NSBubbleType)type
{
    ...
    UIEdgeInsets insets = (type == BubbleTypeSomeoneElse ? imageInsetsMine : imageInsetsSomeone);
